...
/* Half Donut Chart
---------------------------------------------------------- */
class WPBakeryShortCode_Half_Donut_Chart extends WPBakeryShortCode {
}

vc_map( array(
    'name' => __('Vela : Half Donut Chart', 'Vela'),
    'description' => __('Animated half donut chart.', 'Vela'),
    'base' => 'half_donut_chart',
    'class' => '',
    'controls' => 'full',
    'icon' =>  'vela-icon half-donut-chart-icon', 
    'category' => 'VELA',
    'params' => array(
            array(
                'type' => 'textfield',
            ...
            array(
                ...
                'admin_label' => true,
                'value' => '',
                'description' => __('Input chart value here. Choose range between 0 and 100.', 'Vela')
            ),
            array(
                'type' => 'dropdown',
                'class' => '',
