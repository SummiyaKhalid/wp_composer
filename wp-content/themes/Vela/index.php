...
global $wyde_options, $wyde_page_id, $wyde_sidebar_position, $wyde_blog_layout, $grid_columns;
...
if($wyde_sidebar_position == false) $wyde_sidebar_position = $wyde_options['blog_sidebar'];
